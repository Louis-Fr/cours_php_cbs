  ...
  <?php require '../inc/nav.php';?>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            ...
            <p class="lead">Dans PHP, il n'existe pas déclaration explicite du type d'une variable lors de sa création. Même PHP 7 reste un langage pauvrement typé comparé à Java ou au C.</p>
            <hr class="my-4">
        </div>
    </div> <!-- fin juMbotron -->
           ...
           <div class="col-sm-12 col-md-6">
            ...
            <table class="table table-striped">
                <caption>Les opérateurs numériques</caption>
                    ...
                    <h3>Le type boolean ou booléen</h3>
                    ...
                    echo "<div class=\"border border-danger w-50 p-2\"> \$b vaut $b<br>";
