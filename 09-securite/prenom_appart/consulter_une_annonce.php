...
<html lang="fr">
  ...
  <?php  include 'inc/nav.php'; ?>
      ...
      <main class="container">    
          <div class="row">
              <div class="col-sm-12">
                <h1>Consulter une annonce en détail</h1>
                ...
                echo "<table class=\"table table-striped\">";
                    echo "<thead>";
                        ...
                        echo"<th>Description de l'annonce</th>";
                        echo"<th>Code postal</th>";
                        echo"<th>Ville</th>";
                        echo"<th>Type d'annonce</th>";
                        echo"<th>Prix</th>";
                        echo "<th>Message de réservation</th>";
                    echo "</thead>";
                    while ($ligne = $requete->fetch(PDO::FETCH_ASSOC)) {
                        echo "<tr>";
                            ...
                            echo "<td>".$ligne['reservation_message']."</td>";
                            echo "</tr>";
                    }
                echo "</table>";
                ?>
                ...
                <form action="" method="GET">
                    <div>
                        ...
                        <br>
                        <textarea id="reservation" name="reservation">Entrez votre message</textarea>
                     </div>
